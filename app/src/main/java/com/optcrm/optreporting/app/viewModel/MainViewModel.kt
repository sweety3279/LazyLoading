 ...
 */
class MainViewModel(private val activity: Activity, private val database: MasterDB)
    : BaseViewModel(activity), MainConnector.ViewOpt{
    override fun getObjectSuccess(value: Response.ResponseSample) {
    }
    ...
    private val presenterOpt = MainPresenter(this)
